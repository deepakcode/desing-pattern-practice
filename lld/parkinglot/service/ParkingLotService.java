package com.practice.lld.parkinglot.service;

import com.practice.lld.parkinglot.exception.ParkingLotException;
...
import com.practice.lld.parkinglot.model.parking.strategy.ParkingStrategy;
...
public class ParkingLotService {
  ...
  public Integer park(final Car car) {
    // 1. is parking lot exist
    validateParkingLotExists();
    //2. get Parking slot
    final Integer slotNumber = parkingStrategy.getNextSlot();
    //3. assing car on that slot
   ...
   */
  public void unPark(final Integer slotNumber) {
    validateParkingLotExists();
